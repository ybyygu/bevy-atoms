// [[file:../bevy.note::9f7d38fa][9f7d38fa]]
//! # Bevy Pan/Orbit Camera
//!
//! Imported from: https://raw.githubusercontent.com/Plonq/bevy_panorbit_camera/master/src/lib.rs
//!
...
// [[file:../bevy.note::20fd343a][20fd343a]]
...
fn pan_orbit_camera(
    ...
    for (mut pan_orbit, mut transform, mut projection) in camera_query.iter_mut() {
        ...
        if has_moved || pan_orbit.target_alpha != pan_orbit.alpha || pan_orbit.target_beta != pan_orbit.beta {
...
fn orbit_just_pressed_or_released(
    ...
    let just_pressed = pan_orbit.modifier_orbit.map_or(true, |modifier| key_input.pressed(modifier))
        && (mouse_input.just_pressed(pan_orbit.button_orbit) || mouse_input.just_released(pan_orbit.button_orbit));
